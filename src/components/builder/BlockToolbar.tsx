 ...
 *              arquitectura de contexto atomizada y movido a su ubicación canónica.
 ...
 * 2. **Co-localización Canónica**: ((Implementada)) El archivo ahora reside en `src/components/builder/`, junto con los otros componentes de su ecosistema, mejorando la organización del proyecto.
 *
 * =====================================================================
 */
// src/components/builder/BlockToolbar.tsx
