 ...
 * 1. **Renombrar Helper Genérico**: ((Vigente)) Para una DX de élite y para prevenir esta confusión en el futuro, el helper genérico `Views<T>` en `_shared.ts` podría ser renombrado a `ViewRow<T>` para que su propósito (extraer el tipo `Row`) sea semánticamente explícito. Propondré esta refactorización en una futura épica de infraestructura de tipos.
 *
 * =====================================================================
 */
// src/lib/data/admin/types.ts
