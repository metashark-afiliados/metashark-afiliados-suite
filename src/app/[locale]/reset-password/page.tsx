 ...
 * 1. **UX de Élite**: ((Implementada)) Incluye un medidor de fortaleza de contraseña visual y animado para guiar al usuario.
 * 2. **Feedback en Tiempo Real**: ((Implementada)) Usa `useFormState` y `toast` para un feedback inmediato.
 * 3. **Redirección Automática**: ((Implementada)) Redirige al usuario al login después de un cambio exitoso.
 *
 * =====================================================================
 */
// src/app/[locale]/reset-password/page.tsx
