 ...
 *              el `i18nSchema` de Zod, garantizando una sincronización perfecta
 *              entre el contrato de datos y los tipos utilizados en el código.
 * @author @author RaZ Podestá - MetaShark Tech
 * @version 2.0.0
 * @see .docs-espejo/lib/i18n/types.ts.md
 */
 ...
 *              notación de punto (ej. "generic.name_required").
